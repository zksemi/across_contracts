...
import type { SynthetixBridgeToOptimism, SynthetixBridgeToOptimismInterface } from "../../../../contracts/chain-adapters/Optimism_Adapter.sol/SynthetixBridgeToOptimism";
export declare class SynthetixBridgeToOptimism__factory {
    ...
    static createInterface(): SynthetixBridgeToOptimismInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): SynthetixBridgeToOptimism;
}
