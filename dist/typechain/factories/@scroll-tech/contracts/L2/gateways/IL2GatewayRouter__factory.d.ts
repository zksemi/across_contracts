...
import type { IL2GatewayRouter, IL2GatewayRouterInterface } from "../../../../../@scroll-tech/contracts/L2/gateways/IL2GatewayRouter";
export declare class IL2GatewayRouter__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IL2GatewayRouter;
}
