...
export declare type YieldClaimedEvent = TypedEvent<[
    string,
    string,
    BigNumber
], YieldClaimedEventObject>;
export declare type YieldClaimedEventFilter = TypedEventFilter<YieldClaimedEvent>;
