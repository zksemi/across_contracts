...
export interface PolygonERC20PredicateMockInterface extends utils.Interface {
    functions: {
...
export interface PolygonERC20PredicateMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PolygonERC20PredicateMockInterface;
