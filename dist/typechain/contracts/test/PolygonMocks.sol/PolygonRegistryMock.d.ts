...
export interface PolygonRegistryMockInterface extends utils.Interface {
    functions: {
...
export interface PolygonRegistryMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PolygonRegistryMockInterface;
