...
export interface RootChainManagerMockInterface extends utils.Interface {
    functions: {
...
export interface RootChainManagerMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: RootChainManagerMockInterface;
